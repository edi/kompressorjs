  ...
  _createClass(Kompressor, [{
    ...
    value: function draw(_ref2) {
      ...
      if (options.scaleAndCenterCrop) {
        var _ref7 = [options.width, options.height];
        width = _ref7[0];
        height = _ref7[1];
        canvas.width = width;
      ...
      if (options.scaleAndCenterCrop) {
        ...
        context.drawImage(image, Math.floor((naturalWidth - sourceWidthCrop) / 2), Math.floor((naturalHeight - sourceHeightCrop) / 2), Math.floor(sourceWidthCrop), Math.floor(sourceHeightCrop), 0, 0, width, height);
      } else {
