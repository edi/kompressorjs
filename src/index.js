...
export default class Compressor {
  ...
  draw({
    ...
    if (options.scaleAndCenterCrop) {
      const scaleFactorX = naturalWidth / width;
      const scaleFactorY = naturalHeight / height;
      const scaleFactor = scaleFactorX > scaleFactorY ? scaleFactorY : scaleFactorX;
      const sourceWidthCrop = width * scaleFactor;
      const sourceHeightCrop = height * scaleFactor;
